...
def _record_evaluation(outcome: str) -> None:
    metrics = current_app.extensions.get("calculator_metrics")
    if isinstance(metrics, MetricsStore):
        metrics.record_evaluation(outcome)
...
def calculate():
    if not _is_authorized():
        ...
        _record_evaluation("unauthorized")
