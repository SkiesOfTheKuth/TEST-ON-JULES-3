...
def test_calculate_enforces_rate_limit(client) -> None:
    from app import app as flask_app

    original_limit = flask_app.config["RATE_LIMIT"]
    flask_app.config["RATE_LIMIT"] = "1 per minute"
    ...
    try:
        ...
        flask_app.config["RATE_LIMIT"] = original_limit
